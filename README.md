...
An example character is provided below, assuming that you are using the `BasicFramework`:
...
```luau
{
    characterConfig = {
        ...
        character = {
            -- Functions to be passed to the backend. These are not optional - specify an empty table if no functions are needed.
            functions = {
                {
                    name = "color",
